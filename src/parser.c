...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [136] = {.entry = {.count = 1, .reusable = false}}, SHIFT(423),
  ...
  [196] = {.entry = {.count = 1, .reusable = true}}, SHIFT(408),
  ...
  [270] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_statement_repeat1, 2), SHIFT_REPEAT(423),
  ...
  [1145] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_try_statement_repeat1, 2), SHIFT_REPEAT(422),
  ...
  [1302] = {.entry = {.count = 1, .reusable = false}}, SHIFT(37),
  ...
  [1310] = {.entry = {.count = 1, .reusable = true}}, SHIFT(430),
  ...
  [1332] = {.entry = {.count = 1, .reusable = false}}, SHIFT(32),
  [1334] = {.entry = {.count = 1, .reusable = true}}, SHIFT(393),
  [1336] = {.entry = {.count = 1, .reusable = false}}, SHIFT(30),
